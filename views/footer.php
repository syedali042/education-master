        ...
        <div class="container">
            <div class="row">
                <div class="copy-right">
                    <p>Copyrights © 2019 w3schemas. All rights reserved.</p>
                </div>
            </div>
        </div>
    </section>
                    ...
                    <form class="s12" action="<?=BASEURL?>studentLogin" method="POST">
                        <div>
                            <div class="input-field s12">
                                <input type="text" data-ng-model="name" name="student_email" class="validate">
                                <label>Student Email</label>
                            </div>
                        </div>
                        <div>
                            <div class="input-field s12">
                                <input type="password" class="validate" name="student_pass">
...
<!-- Mirrored from rn53themes.net/themes/demo/education-master/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 13 Mar 2021 04:39:54 GMT -->
</html>