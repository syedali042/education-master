				...
				<div class="step-inner-content position-relative">
					<form onsubmit="submitQuizForm()" id="QuizForm" class="multisteps-form__form form" action="javascript://" id="wizard" method="POST">
						<div class="form-area position-relative">
											...
											<p>
												...
												<u>
													<?php foreach ($classes as $key => $class): ?>
														<?php if ($exam['class_id']==$class['class_id']): ?>
															<?=$class['class_title']?>
														<?php endif ?>	
													<?php endforeach ?>										
												</u>
											...
											<p>
												...
												<u>
													<?php foreach ($studentSubjects as $key => $subjects): ?>
														<?php if ($exam['subject_id']==$subjects['subject_id']): ?>
											...
											<p>
												...
												<u>
													<?php foreach ($instructors as $key => $instructor): ?>
														<?php if ($exam['ins_id']==$instructor['user_id']): ?>
							...
							<input type="hidden" id="totalQuestions" value="<?=$exam['exam_time']?>">
							<?php foreach ($examQuestions as $key => $row): ?>
							<div class="multisteps-form__panel js-active" data-animation="fadeIn">
								<div class="wizard-forms position-relative">
									<div class="quiz-title text-center">
										<span>Question <?=$key+1?><br><?=$row['question_title']?></span>
									</div>
										...
										<ul>
											<li>
												<label class="start-quiz-item">
													...
													<span class="exp-label"><?=$row['question_option_one']?></span>
											...
											<li>
												<label>
													...
													<span class="exp-label"><?=$row['question_option_two']?></span>
													<span class="checkmark-border"></span>
												</label>
											</li>
											<li>
												<label>
													...
													<span class="exp-label"><?=$row['question_option_three']?></span>
													<span class="checkmark-border"></span>
												</label>
											</li>
											<li>
												<label>
													...
													<span class="exp-label"><?=$row['question_option_four']?></span>
													<span class="checkmark-border"></span>
												</label>
											</li>
										</ul>
						...
						<input type="hidden" name="action" value="insert-exam">
					</form>
				</div>
			</div>
		...
		<script type="text/javascript">
			...
			let totalTime = parseInt(totalQuestions*60);
